...
<div class="container card">
    @if(Auth::check())
        <h1>Welcome to {{$council->name}} Waste Management Unit</h1>
        @if(Auth::user()->type=="USER" and $client!=null)
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <a href="{{route('add.garbage')}}">
                        <div class="thumbnail">
                            {{--<img src="..." alt="...">--}}
                            <div class="caption">
                ...
                <div class="col-sm-6 col-md-3">
                    <a href="{{route('view_complaint')}}">
                        <div class="thumbnail">
                            {{--<img src="..." alt="...">--}}
                            <div class="caption">
                                <h3>File a complaint/Request</h3>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-sm-6 col-md-3 card">
                    <a href="{{route('admin_complaints')}}">
                        <div class="thumbnail">
                            {{--<img src="..." alt="...">--}}
                            <div class="caption">
                                <h3>View Complaints/Requests</h3>
                                @if($recent_activity==true) <span class="label label-success">New Messeges</span> @endif
                            </div>
                        </div>
                    </a>
        ...
        @elseif(Auth::user()->type=="WORKER")
            @if(Auth::user()->truck_id==null)
                <div class="alert alert-warning alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <strong>Alert!</strong> Please update Your Truck before proceeding
                </div>
            @endif
            @if(Auth::user()->truck_id!=null)
            <div class="col-sm-6 col-md-3">
